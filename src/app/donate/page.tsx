  ...
  return (
    <main className="pt-16">
      <section className="bg-forest-dark py-24 px-6 text-center">
        ...
        <h1 className="text-5xl font-bold text-white mb-5">Support a Greener Tomorrow</h1>
        <p className="text-white/65 max-w-xl mx-auto leading-relaxed text-lg">
          Your donation helps us buy seedlings, tools, water supplies, transportation, and educational materials for communities. Every contribution plants hope.
        </p>
      </section>
      ...
      <section className="bg-forest-fog py-24 px-6">
        <div className="max-w-2xl mx-auto">
          <div className="bg-white border border-forest-mist rounded-3xl p-10 shadow-sm">
            ...
            <p className="text-xs font-semibold text-forest uppercase tracking-widest mb-4">Choose an amount</p>
            ...
            <div id="monthly" className="bg-forest-fog rounded-2xl p-5 mb-6">
              <p className="text-sm font-semibold text-forest-dark mb-1">
                Your impact: <span className="text-forest-light">${custom || selected} {frequency === "monthly" ? "/month" : "one-time"}</span>
              </p>
              <p className="text-xs text-gray-500">
                {(custom ? parseInt(custom) : selected) >= 40
            ...
            <div id="stock" className="mt-6 pt-6 border-t border-forest-mist text-center">
              ...
              <div className="flex gap-3 justify-center">
                ...
                <Link href="/contact" className="border border-forest-mist text-forest-dark text-xs px-4 py-2 rounded-full hover:border-forest-light transition-colors no-underline">
