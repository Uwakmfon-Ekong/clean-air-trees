...
const activities = [
  {
    ...
    desc: "Organized community planting events in cities, schools, and open lands.",
  },
  {
    image: "/schoolprogram.jpg",
    title: "School Environmental Programs",
    desc: "Teaching the next generation about clean air and sustainable living.",
  },
  {
    image: "/cleanup.jpg",
    title: "Community Clean-Up Events",
    desc: "Working together to keep our neighborhoods clean and green.",
  },
  {
    image: "/recycling.jpg",
    title: "Recycling & Waste Reduction",
    desc: "Raising awareness about responsible waste management.",
  },
  {
    image: "/seminar.jpg",
    title: "Public Workshops & Seminars",
    desc: "Educating communities through hands-on learning and open dialogue.",
  },
  {
    image: "/socialcampaign.jpg",
    title: "Social Media Campaigns",
    desc: "Spreading the message of clean air and environmental action globally.",
  },
];
const whyMatters = [
    ...
    <main className="pt-16">
      ...
      <section className="bg-forest-dark py-24 px-6 text-center">
        ...
        <p className="text-white/65 max-w-2xl mx-auto leading-relaxed text-lg">
          A global campaign dedicated to promoting cleaner air, healthier
          communities, and environmental sustainability through tree planting
          and education.
        </p>
        ...
        <div className="max-w-5xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
          ...
          <div>
            ...
            <p className="text-gray-500 leading-relaxed mb-4">
              The Clean Air Trees Project is a global awareness campaign
              encouraging individuals, schools, businesses, and governments to
              work together in reducing air pollution and protecting the planet
              for future generations.
            </p>
            <p className="text-gray-500 leading-relaxed">
              Trees play a vital role in improving air quality by absorbing CO₂,
              releasing oxygen, filtering harmful pollutants, and helping reduce
              climate change. Unfortunately, increasing pollution from vehicles,
              industries, deforestation, and waste burning continues to threaten
        ...
        <div className="max-w-4xl mx-auto">
          ...
          <div className="flex flex-col gap-4">
            {purposes.map((p, i) => (
              <div
                key={p}
                className="flex items-center gap-5 bg-white border border-forest-mist rounded-2xl px-6 py-5 hover:border-forest-light hover:shadow-sm transition-all"
              >
        ...
        <div className="max-w-5xl mx-auto">
          <div className="text-center mb-12">
            ...
            <p className="text-white/60 max-w-xl mx-auto">
              Cleaner air helps communities thrive in every way.
            </p>
          </div>
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
            {whyMatters.map((w) => (
              <div
                key={w}
                className="bg-white/10 border border-white/15 rounded-2xl p-5 flex items-start gap-3"
              >
        ...
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-12">
            ...
            <p className="text-gray-500 max-w-xl mx-auto">
              From the ground to the internet — here's how we're spreading the
              message.
            </p>
          </div>
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
            {activities.map((a) => (
              <div
                key={a.title}
                className="border border-forest-mist rounded-2xl overflow-hidden hover:-translate-y-1 hover:shadow-md transition-all duration-200 group bg-white"
              >
      ...
      <section className="bg-forest-fog py-24 px-6">
        <div className="max-w-4xl mx-auto">
          <div className="text-center mb-12">
            ...
            <p className="text-gray-500 max-w-xl mx-auto">
              Everyone can make a difference. Start with one small action today.
            </p>
          </div>
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
            {whatYouCan.map((w, i) => (
              <div
                key={w}
                className="flex items-center gap-4 bg-white border border-forest-mist rounded-2xl px-6 py-4 hover:border-forest-light transition-all"
              >
      ...
      <section className="bg-forest-dark py-24 px-6 text-center">
        <div className="max-w-3xl mx-auto">
          ...
          <p className="text-white/60 leading-relaxed mb-10">
            Through education, teamwork, and environmental responsibility, we
            can create a better life for present and future generations.
          </p>
