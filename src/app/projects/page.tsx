...
const projects = [
  {
    ...
    tag: "Ongoing",
    desc: "Organizing tree planting events in schools, parks, and neighborhoods across communities. Every event brings families and volunteers together for a greener tomorrow.",
  ...
  },
  {
    ...
    tag: "Education",
    desc: "Teaching the next generation about environmental responsibility and tree care. We partner with schools to build green corners and outdoor learning spaces.",
    href: "/education",
  },
  {
    ...
    tag: "Community",
    desc: "Mobilizing volunteers and youth groups to drive grassroots environmental action in communities that need it most.",
    href: "/volunteer",
  },
  {
  ...
  },
  {
    ...
    href: "/projects/seedlings",
  },
  {
    image: "/impact-monitoring.jpg",
    title: "Impact Monitoring",
    tag: "Research",
    desc: "Tracking the health and growth of planted trees to measure our environmental impact over time.",
    ...
    <main className="pt-16">
      <section className="bg-forest-dark py-24 px-6 text-center">
        ...
        <p className="text-white/65 max-w-xl mx-auto leading-relaxed text-lg">
          From community planting events to school programs — here's where your
          support goes.
        </p>
      </section>
