          ...
          <div className="max-w-5xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            ...
            <div>
              ...
              <p className="text-gray-500 leading-relaxed mb-4">
                ...
                living. TRCC is dedicated to restoring degraded ecosystems,
                conserving biodiversity, and improving livelihoods in Nigeria's
                Niger Delta through sustainable practices.
              </p>
              <p className="text-gray-500 leading-relaxed mb-8">
                ...
                mangrove trees and restored over 500 hectares of land to
                sequester carbon, enhance coastal protection, and mitigate
                flooding.
              </p>
            ...
            <div className="max-w-6xl mx-auto">
              <div className="text-center mb-14">
                ...
                <p className="text-gray-500 max-w-xl mx-auto leading-relaxed">
                  Organizations working alongside us to restore ecosystems and
              ...
              <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-4 gap-6">
                {partners.map((p) => (
                  <a
                    ...
                    target="_blank"
                    rel="noopener noreferrer"
                    className="bg-forest-fog border-2 border-forest-mist rounded-2xl p-8 flex flex-col items-center justify-center gap-4 hover:border-forest-light hover:-translate-y-1 hover:shadow-md transition-all duration-200 no-underline group"
                  >
                    {p.logo ? (
                      <div className="w-full h-16 relative flex items-center justify-center">
                        <img
                          src={p.logo}
                          alt={p.name}
                          className="max-h-16 object-contain group-hover:scale-105 transition-transform duration-200"
                        />
                      </div>
                    ) : (
                      <div className="w-16 h-16 bg-forest-mist rounded-full flex items-center justify-center">
                        <span className="text-forest-dark font-bold text-xl">
                          {p.name.charAt(0)}
                        </span>
                      </div>
                    )}
                    <p className="text-xs font-semibold text-forest-dark uppercase tracking-widest text-center mb-2">
                      {p.name}
                    </p>
                    {p.description && (
